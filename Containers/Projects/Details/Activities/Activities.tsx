    ...
    <div className="w-full flex flex-col gap-3">
      <div className="w-full flex flex-col lg:flex-row gap-3 justify-between">
        <div className="lg:w-1/3 flex flex-col lg:flex-row gap-0.5 bg-gray-600 rounded border border-gray-600">
          <Button className="flex items-center justify-center cursor-pointer bg-[#3B82F6] text-white rounded p-2 lg:w-1/3">
            همه
          </Button>
          <Button className="flex items-center border-s border-e border-gray-600 justify-center bg-[#18181B] text-white cursor-pointer hover:bg-[#3b83f665] rounded p-2 lg:w-1/3">
            من
          </Button>
          <Button className="flex items-center justify-center bg-[#18181B] text-white cursor-pointer hover:bg-[#3b83f665] rounded p-2 lg:w-1/3">
            تیم
          </Button>
        </div>
