...
export default function ProjectItem() {
  return (
    <div className="w-full py-3 px-5 bg-[#18181B] border border-white/10 xl:bg-none hover:bg-[#28282B] hover:border-[#3B82F6] rounded-xl">
      <div className="hidden xl:flex items-center">
        ...
        <div className="w-1/10 text-end">
          <Button style="cursor-pointer p-1 bg-[#28282B] rounded-xl border border-gray-600 hover:bg-[#18181B]">
            <EllipsisVertical />
          </Button>
        </div>
      </div>
